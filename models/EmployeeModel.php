...
class EmployeeModel { 
    ...
    public function createEmployee($data){
        $query = "INSERT INTO " . $this->table_name . " (first_name, last_name, email, department, position, salary, hire_date) 
    ...
    public function getDataViewSummary() {
    ...
    public function refreshDashboardSummary() {
