...
\restrict 5ofshqJaFXG4ryj95jO9HQO3VW25gkJLi513K1dF7yZr7zvxsYSHtZzRDofFoD5

-- Dumped from database version 15.14
-- Dumped by pg_dump version 15.14

-- Started on 2025-11-13 21:19:39
...
--
-- TOC entry 228 (class 1255 OID 25301)
-- Name: get_department_summary(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_department_summary() RETURNS TABLE(department text, employee_count integer, avg_salary numeric, total_budget numeric)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
--
-- TOC entry 227 (class 1255 OID 25300)
...
--
-- TOC entry 220 (class 1259 OID 25248)
...
--
-- TOC entry 223 (class 1259 OID 25264)
...
-- Name: employee_overview; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.employee_overview AS
 SELECT count(*) AS total_karyawan,
    sum(employees.salary) AS total_gaji_per_bulan,
    round(avg((EXTRACT(year FROM age((CURRENT_DATE)::timestamp with time zone, (employees.hire_date)::timestamp with time zone)) + (EXTRACT(month FROM age((CURRENT_DATE)::timestamp with time zone, (employees.hire_date)::timestamp with time zone)) / (12)::numeric))), 2) AS rata_rata_masa_kerja
   FROM public.employees;


ALTER TABLE public.employee_overview OWNER TO postgres;
...
--
-- TOC entry 217 (class 1259 OID 25237)
...
--
-- TOC entry 219 (class 1259 OID 25247)
...
--
-- TOC entry 224 (class 1259 OID 25288)
-- Name: salary_stats; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.salary_stats AS
 SELECT employees.department,
    round(avg(employees.salary), 2) AS avg_salary,
    max(employees.salary) AS max_salary,
    min(employees.salary) AS min_salary
...
ALTER TABLE public.salary_stats OWNER TO postgres;

--
-- TOC entry 225 (class 1259 OID 25292)
...
CREATE VIEW public.tenure_stats AS
 SELECT
        CASE
            WHEN (age((CURRENT_DATE)::timestamp with time zone, (employees.hire_date)::timestamp with time zone) < '1 year'::interval) THEN 'Junior'::text
            WHEN ((age((CURRENT_DATE)::timestamp with time zone, (employees.hire_date)::timestamp with time zone) >= '1 year'::interval) AND (age((CURRENT_DATE)::timestamp with time zone, (employees.hire_date)::timestamp with time zone) <= '3 years'::interval)) THEN 'Middle'::text
            ELSE 'Senior'::text
        END AS level_kerja,
...
--
-- TOC entry 3213 (class 2604 OID 16545)
...
--
-- TOC entry 3215 (class 2604 OID 25241)
...
--
-- TOC entry 3217 (class 2604 OID 25251)
...
--
-- TOC entry 3378 (class 0 OID 16542)
-- Dependencies: 215
...
--
-- TOC entry 3379 (class 0 OID 16572)
-- Dependencies: 216
...
--
-- TOC entry 3381 (class 0 OID 25238)
-- Dependencies: 218
...
1	Ahmad	Hidayat	ahmad.hidayat@company.com	IT	Software Engineer	8500000.00	2022-01-15	2025-11-07 08:11:09.864937
2	Siti	Rahayu	siti.rahayu@company.com	HR	HR Manager	9500000.00	2021-03-20	2025-11-07 08:11:09.864937
3	Budi	Santoso	budi.santoso@company.com	Finance	Accountant	7500000.00	2022-06-10	2025-11-07 08:11:09.864937
4	Dewi	Anggraini	dewi.anggraini@company.com	Marketing	Marketing \nSpecialist	7000000.00	2023-02-01	2025-11-07 08:11:09.864937
5	Rizki	Pratama	rizki.pratama@company.com	IT	System Administrator	8000000.00	2021-11-05	2025-11-07 08:11:09.864937
6	Maya	Sari	maya.sari@company.com	Finance	Financial Analyst	8200000.00	2022-08-15	2025-11-07 08:11:09.864937
7	Joko	Widodo	joko.widodo@company.com	Operations	Operations \nManager	11000000.00	2020-05-12	2025-11-07 08:11:09.864937
8	Linda	Permata	linda.permata@company.com	Marketing	Digital \nMarketer	6800000.00	2023-01-30	2025-11-07 08:11:09.864937
9	Fajar	Nugroho	fajar.nugroho@company.com	IT	Web Developer	7800000.00	2022-09-22	2025-11-07 08:11:09.864937
10	Rina	Wulandari	rina.wulandari@company.com	HR	Recruitment \nSpecialist	6500000.00	2023-03-10	2025-11-07 08:11:09.864937
11	Hendra	Kurniawan	hendra.kurniawan@company.com	Finance	Tax \nOfficer	7200000.00	2022-04-18	2025-11-07 08:11:09.864937
12	Dian	Puspita	dian.puspita@company.com	IT	Database Administrator	9000000.00	2021-07-25	2025-11-07 08:11:09.864937
13	Eko	Supriyanto	eko.supriyanto@company.com	Operations	Logistics \nCoordinator	6000000.00	2023-05-05	2025-11-07 08:11:09.864937
14	Fitri	Handayani	fitri.handayani@company.com	Marketing	Content \nCreator	5800000.00	2023-04-12	2025-11-07 08:11:09.864937
15	Gita	Maharani	gita.maharani@company.com	HR	Training Officer	6200000.00	2022-12-01	2025-11-07 08:11:09.864937
16	Irfan	Setiawan	irfan.setiawan@company.com	IT	Network Engineer	8300000.00	2021-09-14	2025-11-07 08:11:09.864937
17	Kartika	Dewi	kartika.dewi@company.com	Finance	Auditor	7700000.00	2022-03-08	2025-11-07 08:11:09.864937
18	Lukman	Hakim	lukman.hakim@company.com	Operations	Warehouse \nManager	7300000.00	2021-12-20	2025-11-07 08:11:09.864937
19	Nina	Zahra	nina.zahra@company.com	Marketing	Social Media \nSpecialist	5900000.00	2023-06-25	2025-11-07 08:11:09.864937
20	Oscar	Fernando	oscar.fernando@company.com	IT	Mobile Developer	8100000.00	2022-11-11	2025-11-07 08:11:09.864937
\.


--
-- TOC entry 3383 (class 0 OID 25248)
-- Dependencies: 220
...
--
-- TOC entry 3222 (class 2606 OID 16577)
...
--
-- TOC entry 3224 (class 2606 OID 25246)
...
--
-- TOC entry 3226 (class 2606 OID 25244)
...
--
-- TOC entry 3228 (class 2606 OID 25254)
...
--
-- TOC entry 3384 (class 0 OID 25264)
...
-- Completed on 2025-11-13 21:19:39

--
-- PostgreSQL database dump complete
--

\unrestrict 5ofshqJaFXG4ryj95jO9HQO3VW25gkJLi513K1dF7yZr7zvxsYSHtZzRDofFoD5
